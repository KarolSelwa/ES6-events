export const JSSlider = class {

    constructor(galery) {
        this.imagesSelector = galery
    ...
    run() {
        ...
        this.sliderRootElement = document.querySelector(this.slider);
    ...
    initEvents() {
        this.imagesList.forEach((item) => {
            item.addEventListener('click', (e) => {
                ...
                this.fireCustomEvent(this.sliderRootElement, 'js-slider-img-start');
        ...
        const Arrow = this.sliderRootElement.querySelectorAll(".js-slider__nav")
        Arrow.forEach((element)=>{
            element.addEventListener('mouseleave', () => {
                this.fireCustomEvent(this.sliderRootElement, 'js-slider-img-start')
            });
            element.addEventListener('mouseenter', () => {
                this.fireCustomEvent(this.sliderRootElement, 'js-slider-img-stop')
            });
        })
    ...
    initCustomEvents() {
        ...
        this.sliderRootElement.addEventListener('js-slider-img-start', this.onStart.bind(this));
        this.sliderRootElement.addEventListener('js-slider-img-stop', this.onStop.bind(this));
    }
